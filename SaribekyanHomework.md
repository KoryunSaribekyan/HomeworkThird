...
![Это Тефтелька](https://www.gastronom.ru/binfiles/images/20160315/b6c09155.jpg)
...
3. git push - Эта команда позволяет отправить нашу версию репозитория на внешний репозиторий.
